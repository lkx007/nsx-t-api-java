 ...
 */
@Schema(description = "This condition is used to match HTTP request messages by HTTP header fields. HTTP header fields are components of the header section of HTTP request and response messages. They define the operating parameters of an HTTP transaction. For example, Cookie, Authorization, User-Agent, etc. One condition can be used to match one header field, to match multiple header fields, multiple conditions must be specified. The match_type field defines how header_value field is used to match HTTP requests. The header_name field does not support match types. ")
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2020-02-19T07:44:41.574+08:00[Asia/Shanghai]")
public class LbHttpRequestHeaderCondition extends LbRuleCondition {
  ...
  public LbHttpRequestHeaderCondition headerValue(String headerValue) {
   ...
   * @return headerValue
  **/
  @Schema(required = true, description = "Value of HTTP header")
  ...
  public LbHttpRequestHeaderCondition caseSensitive(Boolean caseSensitive) {
  ...
  **/
  ...
  public LbHttpRequestHeaderCondition matchType(MatchTypeEnum matchType) {
  ...
  **/
  ...
  public LbHttpRequestHeaderCondition headerName(String headerName) {
   ...
   * @return headerName
  **/
  @Schema(required = true, description = "Name of HTTP header")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    LbHttpRequestHeaderCondition lbHttpRequestHeaderCondition = (LbHttpRequestHeaderCondition) o;
    return Objects.equals(this.headerValue, lbHttpRequestHeaderCondition.headerValue) &&
        Objects.equals(this.caseSensitive, lbHttpRequestHeaderCondition.caseSensitive) &&
        Objects.equals(this.matchType, lbHttpRequestHeaderCondition.matchType) &&
        Objects.equals(this.headerName, lbHttpRequestHeaderCondition.headerName) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class LbHttpRequestHeaderCondition {\n");

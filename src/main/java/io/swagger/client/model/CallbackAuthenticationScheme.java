 ...
 */
@Schema(description = "CallbackAuthenticationScheme describes how notification requests should authenticate to the server.")
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2020-02-19T07:44:41.574+08:00[Asia/Shanghai]")
public class CallbackAuthenticationScheme {
  ...
  public CallbackAuthenticationScheme username(String username) {
  ...
  **/
  ...
  public CallbackAuthenticationScheme certificateId(String certificateId) {
  ...
  **/
  ...
  public CallbackAuthenticationScheme schemeName(SchemeNameEnum schemeName) {
   ...
   * @return schemeName
  **/
  @Schema(required = true, description = "Authentication scheme to use when making notification requests to the partner console. Specify one of BASIC_AUTH or CERTIFICATE.")
  ...
  public CallbackAuthenticationScheme password(String password) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CallbackAuthenticationScheme callbackAuthenticationScheme = (CallbackAuthenticationScheme) o;
    return Objects.equals(this.username, callbackAuthenticationScheme.username) &&
        Objects.equals(this.certificateId, callbackAuthenticationScheme.certificateId) &&
        Objects.equals(this.schemeName, callbackAuthenticationScheme.schemeName) &&
        Objects.equals(this.password, callbackAuthenticationScheme.password);
  }
  ...
  public String toString() {
    ...
    sb.append("class CallbackAuthenticationScheme {\n");

 ...
 */
@Schema(description = "Details of container cluster node i.e. container host.")
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2020-02-19T07:44:41.574+08:00[Asia/Shanghai]")
public class ContainerClusterNode extends DiscoveredResource {
  ...
  public ContainerClusterNode containerClusterId(String containerClusterId) {
  ...
  **/
  ...
  public ContainerClusterNode originProperties(List<KeyValuePair> originProperties) {
    this.originProperties = originProperties;
    return this;
  }

  public ContainerClusterNode addOriginPropertiesItem(KeyValuePair originPropertiesItem) {
  ...
  **/
  @Schema(description = "Array of additional specific properties of container cluster node in key-value format. ")
  ...
  public ContainerClusterNode externalId(String externalId) {
   ...
   * @return externalId
  **/
  @Schema(required = true, description = "External identifier of the container cluster node in K8S/PAS. ")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ContainerClusterNode containerClusterNode = (ContainerClusterNode) o;
    return Objects.equals(this.containerClusterId, containerClusterNode.containerClusterId) &&
        Objects.equals(this.originProperties, containerClusterNode.originProperties) &&
        Objects.equals(this.externalId, containerClusterNode.externalId) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class ContainerClusterNode {\n");

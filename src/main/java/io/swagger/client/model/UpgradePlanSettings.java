...
public class UpgradePlanSettings {
  ...
  public UpgradePlanSettings pauseAfterEachGroup(Boolean pauseAfterEachGroup) {
  ...
  **/
  @Schema(description = "Flag to indicate whether to pause the upgrade after upgrade of each group is completed")
  ...
  public UpgradePlanSettings pauseOnError(Boolean pauseOnError) {
   ...
   * @return pauseOnError
  **/
  @Schema(description = "Flag to indicate whether to pause the upgrade plan execution when an error occurs")
  ...
  public UpgradePlanSettings parallel(Boolean parallel) {
   ...
   * @return parallel
  **/
  @Schema(description = "Upgrade Method to specify whether the upgrade is to be performed serially or in parallel")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    UpgradePlanSettings upgradePlanSettings = (UpgradePlanSettings) o;
    return Objects.equals(this.pauseAfterEachGroup, upgradePlanSettings.pauseAfterEachGroup) &&
        Objects.equals(this.pauseOnError, upgradePlanSettings.pauseOnError) &&
        Objects.equals(this.parallel, upgradePlanSettings.parallel);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpgradePlanSettings {\n");

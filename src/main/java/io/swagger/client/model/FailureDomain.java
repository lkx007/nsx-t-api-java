...
public class FailureDomain extends ManagedResource {
  @SerializedName("preferred_active_edge_services")
  private Boolean preferredActiveEdgeServices = null;

  public FailureDomain preferredActiveEdgeServices(Boolean preferredActiveEdgeServices) {
    this.preferredActiveEdgeServices = preferredActiveEdgeServices;
    return this;
  }
   ...
   * @return preferredActiveEdgeServices
  **/
  @Schema(description = "Set preference for edge transport node failure domain which will be considered while doing auto placement of logical router, DHCP and MDProxy on edge node. true: For preemptive failover mode, active edge cluster member       allocation preferes this failure domain. false: For preemptive failover mode, standby edge cluster member       allocation preferes this failure domain. Default will be unset. It means no explicit preference. ")
  public Boolean isPreferredActiveEdgeServices() {
    return preferredActiveEdgeServices;
  }

  public void setPreferredActiveEdgeServices(Boolean preferredActiveEdgeServices) {
    this.preferredActiveEdgeServices = preferredActiveEdgeServices;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    FailureDomain failureDomain = (FailureDomain) o;
    return Objects.equals(this.preferredActiveEdgeServices, failureDomain.preferredActiveEdgeServices) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(preferredActiveEdgeServices, super.hashCode());
  }
  ...
  public String toString() {
    ...
    sb.append("class FailureDomain {\n");
    sb.append("    ").append(toIndentedString(super.toString())).append("\n");
    sb.append("    preferredActiveEdgeServices: ").append(toIndentedString(preferredActiveEdgeServices)).append("\n");
    sb.append("}");
    return sb.toString();
  }

...
import io.swagger.client.model.DSSectionState;
...
public class FirewallSectionState extends DSSectionState {
  @SerializedName("pending_change_list")
  private List<PendingChange> pendingChangeList = new ArrayList<PendingChange>();

  public FirewallSectionState pendingChangeList(List<PendingChange> pendingChangeList) {
    this.pendingChangeList = pendingChangeList;
    return this;
  }

  public FirewallSectionState addPendingChangeListItem(PendingChange pendingChangeListItem) {
  ...
  **/
  @Schema(required = true, description = "Pending changes to be realized.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    FirewallSectionState firewallSectionState = (FirewallSectionState) o;
    return Objects.equals(this.pendingChangeList, firewallSectionState.pendingChangeList) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class FirewallSectionState {\n");
